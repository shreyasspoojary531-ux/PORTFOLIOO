...
const OptionWheel = forwardRef(({
  ...
  const updateLayout = useCallback((pos) => {
  ...
  useImperativeHandle(ref, () => ({
    applyTarget,
    setTarget: (val, snap = false) => applyTarget(val, snap),
    getCurrentIndex: () => selectedRef.current,
  ...
  }, [items, fontSize, spacing, curve, tilt, blur, fade, minOpacity, side, loop, updateLayout]);
